// Generated on 2017-09-06 using generator-angular-fullstack 4.1.4
'use strict';
...
gulp.task('copy:images', () => {
    return gulp.src([`${clientPath}/assets/images/**/*`]).pipe(gulp.dest(`${paths.dist}/${clientPath}/assets/images`));
});
